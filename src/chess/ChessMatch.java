...
public class ChessMatch {
    ...
    public ChessPiece perfomChessMove(ChessPosition chessPosition, ChessPosition targetPosition) {
    ...
    private void validateSourcePosition(Position position) {
        ...
        if (currentPlayer != ((ChessPiece)board.piece(position)).getColor()) {
            throw new ChessException("The chosen piece is not yours to move");
        }
